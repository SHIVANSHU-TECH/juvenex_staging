...
export async function GET(
  ...
  try {
    ...
    // Tenant isolation: only list followers of users in your own organization.
    ...
    if (error) {
      logger.error('Followers list error', { error: error.message })
    ...
    logger.error('Followers list error', {
